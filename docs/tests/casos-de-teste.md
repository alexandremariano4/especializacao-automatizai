...
| 4  | Observar a página resultante (`/success`) | O redirecionamento ocorre, mas a página exibe "Pedido Reprovado!" ou falha visual (ícone de X) com a mensagem apropriada. |
